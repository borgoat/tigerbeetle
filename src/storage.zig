    ...
    fn fallocate(fd: i32, mode: i32, offset: i64, length: i64) !void {
        ...
        while (true) {
            ...
            switch (os.linux.getErrno(rc)) {
                os.linux.E.SUCCESS => return,
                os.linux.E.BADF => return error.FileDescriptorInvalid,
                os.linux.E.FBIG => return error.FileTooBig,
                os.linux.E.INTR => continue,
                os.linux.E.INVAL => return error.ArgumentsInvalid,
                os.linux.E.IO => return error.InputOutput,
                os.linux.E.NODEV => return error.NoDevice,
                os.linux.E.NOSPC => return error.NoSpaceLeft,
                os.linux.E.NOSYS => return error.SystemOutdated,
                os.linux.E.OPNOTSUPP => return error.OperationNotSupported,
                os.linux.E.PERM => return error.PermissionDenied,
                os.linux.E.SPIPE => return error.Unseekable,
                os.linux.E.TXTBSY => return error.FileBusy,
                else => |errno| return os.unexpectedErrno(errno),
            }
        }
    }
