...
pub fn on_create_accounts(
    ...
    _ = user_data;
    _ = operation;
    print_results(tb.CreateAccountsResult, results);
}
...
pub fn on_lookup_accounts(
    ...
    _ = user_data;
    _ = operation;
    print_results(tb.Account, results);
}
...
pub fn on_create_transfers(
    ...
    _ = user_data;
    _ = operation;
    print_results(tb.CreateTransfersResult, results);
}
...
pub fn on_commit_transfers(
    ...
    _ = user_data;
    _ = operation;
    print_results(tb.CommitTransfersResult, results);
}
